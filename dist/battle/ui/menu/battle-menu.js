...
import {
  ...
  SUB_BATTLE_UI_TEXT_STYLE,
} from "./battle-menu-config.js";
import { BattleMonster } from "../../monster/battle-monster.js";
...
export class BattleMenu {
  ...
  /** @type {boolean} */
  #queuedMessagesAnimationPlaying;
  /**
   *
  ...
  constructor(scene, activePlayerMonster) {
    ...
    this.#queuedMessagesAnimationPlaying = false;
  ...
  showMainBattleMenu() {
    this.#activeBattleMenu = ACTIVE_BATTLE_MENU.BATTLE_MAIN;
    this.#battleTextGameObjectLine1.setText("Hello World");
  ...
  handlePlayerInput(input) {
    if (this.#queuedMessagesAnimationPlaying && input === "OK") {
      return;
    }
  ...
  #updateInfoPaneWithMessage() {
    ...
    // cek jika semua messages tampil di antrian dan panggil callback
    ...
    // get first messages from queue and animate message
    ...
    this.#queuedMessagesAnimationPlaying = true;
    animateText(
      this.#scene,
